...
export const portalAccountExpeditionInitAdvancedFilters = async () => {
    // URL para obtener los filtros
    const url = '/account/expedition/list/advanced_filters';

    // Comprobar si existe el botón de búsqueda avanzada
    const advancedSearchToggle = document.getElementById('page-expedition-list-advanced-search-toggle');
    if (!advancedSearchToggle) return;

    // Evento para mostrar/ocultar el panel de búsqueda avanzada
    advancedSearchToggle.addEventListener('click', () => {
        const advancedSearchPanel = document.getElementById('page-expedition-list-advanced-search-panel');
...
export const initAdvancedSearch = () => {
    // Botones de acción
    const addLineBtn = document.getElementById('page-expedition-list-advanced-search-add-line-btn');
    const applyBtn = document.getElementById('page-expedition-list-advanced-search-apply-btn');
    const resetBtn = document.getElementById('page-expedition-list-advanced-search-reset-btn');
    const matchTypeSelect = document.getElementById('page-expedition-list-advanced-search-match-type');

    // Contenedor para las líneas
    const linesContainer = document.getElementById('page-expedition-list-advanced-search-lines-container');

    // Dominio de búsqueda
    const searchDomainInput = document.getElementById('page-expedition-list-advanced-search-domain');
    ...
    const fieldsInput = document.getElementById('page-expedition-list-advanced-search-fields');
    ...
    addLineBtn.addEventListener('click', () => {
        ...
        const lineHtml = `
            <div class="filter-line flex flex-wrap space-x-2 items-center" id="page-expedition-list-advanced-search-line-${lineCount}">
