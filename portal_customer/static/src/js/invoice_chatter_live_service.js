...
const initInvoiceDetailsChatterLiveService = () => {
    ...
    websocketWorker.websocket.addEventListener("message", (event) => {
        ...
        for(const action of data) {
            ...
            if(message.type === 'portal_customer.invoice_details_reload_request') {
                document.dispatchEvent(new CustomEvent('portal_customer.invoice_details_reload_request', { detail: message.payload }));
            }
        }
    });
