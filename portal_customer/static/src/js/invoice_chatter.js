...
const reloadInvoiceDetailsChatter = async () => {
    ...
    const response = await rpc('/portal_customer/invoice/details/chatter/fetch', {
...
const initMessageSending = () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            const result = await fetch('/portal_customer/invoice/details/chatter/post', {
                method: 'POST',
                body: formData
            });
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('portal_customer.invoice_details_reload_request', (event) => {
