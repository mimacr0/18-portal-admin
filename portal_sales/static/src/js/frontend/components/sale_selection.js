export const portalAccountSaleInitCheckboxSelect = () => {

    const selectAllCheckbox = document.getElementById('page-sale-list-select-all-checkbox');
    ...
    function updateSelectAllCheckbox() {
        const visibleCheckboxes = Array.from(document.querySelectorAll('.orders-list-checkbox')).filter(checkbox =>
