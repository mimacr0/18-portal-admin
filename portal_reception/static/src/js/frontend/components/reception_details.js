...
const reloadReceptionDetailsChatter = async () => {
...
const initMessageSending = () => {
    ...
    const fileInput = document.getElementById('page-details-reception_details-message-attachment-input');
    const tokenInput = document.getElementById('page-details-reception_details-message-attachment-token');
    ...
    const sendMessage = async () => {
        ...
        try {
            const result = await fetch('/portal_reception/reception/details/chatter/post', {
                method: 'POST',
                body: formData
            });
...
document.addEventListener('DOMContentLoaded', () => {
    reloadReceptionDetailsChatter();
    initMessageSending();

    document.addEventListener('portal_reception.reception_details_reload_request', (event) => {
        console.log('Reloading reception details chatter', event.detail);
        reloadReceptionDetailsChatter();
    });
});
