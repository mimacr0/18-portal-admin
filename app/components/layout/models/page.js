...
export class Page {
    ...
    async render(data={}) {
        return await renderModule(path.join(this.module, 'views', this.view), { page: this, data })
    }

    async renderJS(data={}) {
        return await renderModule(path.join(this.module, 'js', this.jsView), { page: this, data })
    }
}